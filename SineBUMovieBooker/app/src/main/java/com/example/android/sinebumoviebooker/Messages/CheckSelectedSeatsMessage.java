...
public class CheckSelectedSeatsMessage {
    public String type;
    public ArrayList<int[]> selectedSeats;
    public String date;
    public AvailableMovie selectedMovie;

    public CheckSelectedSeatsMessage(String type, ArrayList<int[]> selectedSeats, String date, AvailableMovie selectedMovie){
        this.setType(type);
